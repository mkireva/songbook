      ...
      <div className="flex flex-col min-h-screen items-center ">
        <div className="container lg:w-3/4 p-4">
          ...
          <div className="p-2">
            ...
            <p className="text-md mt-5">{t("content.paragraph2")}</p>
            ...
            <p className="text-md mt-5">{t("content.paragraph6")}</p>
            <p className="text-md mt-5">{t("content.paragraph7")}</p>
            <ul className="list-decimal list-inside mt-5">
            ...
            <p className="text-md mt-5">{t("content.paragraph8")}</p>
            <p className="text-md mt-5">{t("content.paragraph9")}</p>
